...
export const my: IMy = {
  projects: {
    ...
    bullets: [
      'React web application using vite as the bundler and compiler - https://github.com/BentAllenDesign/portfolio-web',
      ...
      'Full-stack Discord bot with PostgreSQL backing database deployed to a Heroku dyno. This bot handles awarding/removing user tickets as well as setting up raffles for said users to participate in. Actively being used by indie game studio DropBears Games - Code available upon request',
  ...
  jobs: [
    {
      ...
      bullets: [
        ...
        "Used Apollo Client as the frontend GraphQL tool for secure typing and global state management",
        ...
        "Created dozens of versioned Flyway migrations to futher expand our database tables, views, materialized views, functions, and triggers",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Provided assistance in understanding game design preproduction concepts",
